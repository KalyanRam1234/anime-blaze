        ...
        <div className="w-full bg-[#3c3b3b]">
            <div className="grid grid-cols-12 px-4 md:px-12 pt-20 min-h-screen">
                <div className="col-span-12 ">
                    <iframe src="https://gotaku1.com/embedplus?id=MTg0MTQx&token=mxV12V_EWOWCr2eN8JXRKw&expires=1691917241" allowFullScreen="true" className="checkh mx-auto w-full"></iframe>
                </div>
                ...
                <div className="col-span-12 overflow-x-hidden overflow-y-auto mb-8">
